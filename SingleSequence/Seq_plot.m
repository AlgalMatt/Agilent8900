...
if any(Pindx==1)
    for i=1:numel(Eindx)
        ...
        errorbar(datenum(DatTab{1}{Sindx, 'Time'}), DatTab{1}{Sindx, Elements{Eindx(i)}}, 2*ErrTab{1}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',18)
        hold on
        errorbar(datenum(DatTab{1}{Sindx, 'Time'}), DatTab{1}{Sindx, Elements{Eindx(i)}}, 1*ErrTab{1}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',6)
        datetick('x',13)
...
if any(Pindx==2)
    for i=1:numel(Eindx)
        ...
        errorbar(datenum(DatTab{2}{Sindx, 'Time'}), DatTab{2}{Sindx, Elements{Eindx(i)}}, 2*ErrTab{2}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',18)
        hold on
        errorbar(datenum(DatTab{2}{Sindx, 'Time'}), DatTab{2}{Sindx, Elements{Eindx(i)}}, 1*ErrTab{2}{Sindx, Elements{Eindx(i)}}, 'o-r','CapSize',6)
        datetick('x',13)
...
if any(Pindx==3)
    for i=1:numel(Eindx)
        ...
        errorbar(datenum(DatTab{3}{Sindx, 'Time'}), DatTab{3}{Sindx, Elements{Eindx(i)}}, 2*ErrTab{3}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',18)
        hold on
        errorbar(datenum(DatTab{3}{Sindx, 'Time'}), DatTab{3}{Sindx, Elements{Eindx(i)}}, 1*ErrTab{3}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',6)
        datetick('x',13)
...
if any(Pindx==4)
    for i=1:numel(Eindx)
        ...
        errorbar(datenum(DatTab{4}{Sindx, 'Time'}), DatTab{4}{Sindx, Elements{Eindx(i)}}, 2*ErrTab{4}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',18)
        hold on
        errorbar(datenum(DatTab{4}{Sindx, 'Time'}), DatTab{4}{Sindx, Elements{Eindx(i)}}, 1*ErrTab{4}{Sindx, Elements{Eindx(i)}}, 'o-r', 'CapSize',6)
        datetick('x',13)
        title([Elements{Eindx(i)}, '/Ca43 ' char(177) '2\sigma'])
        xlabel('Time')
...
if any(Pindx==5)
    ...
    for i=1:numel(Eindx)
        ...
        p1=plot(std8301f_T.Time, std8301f_T{:, Elements{Eindx(i)}}, 'ob');
        yline(nanmean(std8301f_T{:, Elements{Eindx(i)}}), 'b');
        yline(nanmean(std8301f_T{:, Elements{Eindx(i)}})+nanstd(std8301f_T{:, Elements{Eindx(i)}})*2, '-.b');
        yline(nanmean(std8301f_T{:, Elements{Eindx(i)}})-nanstd(std8301f_T{:, Elements{Eindx(i)}})*2, '-.b');
        hold on
        p2=plot(DatTab{4}{s8301fidx, 'Time'}, DatTab{4}{s8301fidx, Elements{Eindx(i)}}, 'or', 'MarkerFaceColor', 'r');
        title(['8301f ', Elements{Eindx(i)}, '/Ca43 ' char(177) '2\sigma'])
        xlabel('Time')
        ylabel([Elements{Eindx(i)}, '/Ca43 (\mumol/mol)'])
        grid on
        legend([p1, p2], 'Previous data', 'This run')
